...
def bankNameInput = findTestObject('Object Repository/Hohh/Application Page/dydropdown_Details_text',
...
def warningMessageLocator = findTestObject('Object Repository/Hohh/Application Page/dywarningmessage_Input_text',
	[('text') : GlobalVariable.inputValidation_InputTitle['bankName']])
String emptyWarningMessage = GlobalVariable.inputValidation_Empty['bankName']
