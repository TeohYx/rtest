...
def dobInput = findTestObject('Object Repository/Hohh/Application Page/input_DOB')
...
def warningMessageLocator = findTestObject('Object Repository/Hohh/Application Page/dywarningmessage_Input_text',
	[('text') : GlobalVariable.inputValidation_InputTitle['dob']])

String emptyWarningMessage = GlobalVariable.inputValidation_Empty['dob']
String placeholderText = GlobalVariable.inputValidation_Placeholder['dob']

def validScenario = ['28092000'] // 1normal
def invalidScenario = ['2809200'] // 1 failed minimum
