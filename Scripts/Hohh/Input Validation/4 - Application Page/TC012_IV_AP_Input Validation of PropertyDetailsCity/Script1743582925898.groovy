...
def warningMessageLocator = findTestObject('Object Repository/Hohh/Application Page/warningmessage_PropertyCity')

String emptyWarningMessage = GlobalVariable.inputValidation_Empty['city']
String placeholderText = GlobalVariable.inputValidation_Placeholder['city']
