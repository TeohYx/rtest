...
def expandTabGold = findTestObject('Object Repository/Hohh/Declaration Page/dybutton_DeclarationTab_text',
	[('text') : GlobalVariable.dyobj_ORDP003['collectibles']])
def goldDescriptionInput = findTestObject('Object Repository/Hohh/Declaration Page/dyinput_DeclareDescription_text',
	[('text') : GlobalVariable.dyobj_ORDP003['collectibles']])
...
(isPassed, log) = CustomKeywords.'inputValidation.inputValidation.performValidation'(
	goldDescriptionInput,
	[1, 2, 3, 5, 6],
	[
		2: ['placeholderText': placeholderText],
		3: ['allowedType': "N,UL,LL,S"],
		5: ['invalidType': ""],
		6: ['haveSpace': true]
	])
