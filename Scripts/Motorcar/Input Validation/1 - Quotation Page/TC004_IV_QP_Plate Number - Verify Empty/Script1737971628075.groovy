...
String warningText = WebUI.callTestCase(
	...
	[('objectLocator'): findTestObject('Object Repository/Motorcar and Motorcycle/Quotation Page/wrnmsg_Plate Number')], 
	FailureHandling.STOP_ON_FAILURE
	)

WebUI.verifyEqual(warningText, GlobalVariable.errorMessage_plateNumberEmpty)
