...
(maxLength, inputTextLength) = WebUI.callTestCase(findTestCase('Reusable Module/Input Validation/TC001_RM_IV_Obtain Max Length'), [('objectLocator') : findTestObject('Object Repository/Motorcar and Motorcycle/Quotation Page/input_Army ID Number')], 
