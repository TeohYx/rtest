...
TestObject objectLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/4 - Bank Accounts Details/input_Account Number')
...
WebUI.callTestCase(
	...
	[('objectLocator') : objectLocator, ('haveSpace') : true],
