...
TestObject placeholderLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/4 - Bank Accounts Details/input_Account Number')
...
String placeholder = WebUI.getAttribute(placeholderLocator, 'placeholder')

WebUI.verifyEqual(placeholder, GlobalVariable.placeholder_AccountNumber)
