...
TestObject warningMessage = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/wrnmsg_Ethnicity')
TestObject saveItemLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/button_Save Personal Details')
...
WebUI.verifyElementPresent(findTestObject('Motorcar and Motorcycle/Plan Page/3 - Personal Details/button_Marital Status'), 0)
