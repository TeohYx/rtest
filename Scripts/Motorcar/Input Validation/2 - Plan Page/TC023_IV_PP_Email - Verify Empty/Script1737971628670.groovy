...
TestObject warningMessage = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/wrnmsg_Email')
...
WebUI.verifyEqual(warningText, GlobalVariable.errorMessage_PersonalDetailEmail)
