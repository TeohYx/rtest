...
TestObject warningMessage = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/wrnmsg_Postcode')
...
WebUI.verifyEqual(warningText, GlobalVariable.errorMessage_PersonalDetailPostcode)
