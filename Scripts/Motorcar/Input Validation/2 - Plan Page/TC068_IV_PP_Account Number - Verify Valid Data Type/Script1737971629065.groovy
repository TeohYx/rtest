...
TestObject textObject = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/4 - Bank Accounts Details/input_Account Number')
...
(validation, errorMessage) = CustomKeywords.'inputValidation.validation.verifyValidData'('S,UL,LL', textObject)
