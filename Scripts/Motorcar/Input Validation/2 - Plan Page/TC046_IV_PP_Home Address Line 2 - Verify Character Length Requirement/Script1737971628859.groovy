...
TestObject textObject = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/input_Home Address 2')
TestObject warningMessageLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/wrnmsg_Home Address 2')
...
CustomKeywords.'inputValidation.validation.verifyCharacterLength'(textObject, warningMessageLocator, submitLocator, "Bukit Damansara, 50490, Kuala Lumpur", "Dama") // >=5
