...
/**
 * Calculate if the total motorcar premium is correctly calculated
 */
...
String totalMotorcyclePremium = WebUI.getText(findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/1 - Quotation Details/txt_Total Motor Premium', [('premium'): 'Total Motor Premium']))
...
double result = (df.format(((calculatedGrossPremium - calculatedDiscount) + calculatedServiceTax) + stampDutyAmount)).toDouble()
