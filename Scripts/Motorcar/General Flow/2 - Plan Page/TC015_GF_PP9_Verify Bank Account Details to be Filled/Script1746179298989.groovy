...
/**
 * Verify 2 cases -
 * 1. When bank account details is not filled, and the button to declaration page is clicked, and specific error should present.
 * 2. When bank account details is filled, and button is clicked, the specific error should not showed. 
 */
...
WebUI.verifyElementPresent(findTestObject('Motorcar and Motorcycle/Plan Page/button_Bank Account Details_Warning Message'), 3)
...
WebUI.verifyElementNotPresent(findTestObject('Motorcar and Motorcycle/Plan Page/button_Bank Account Details_Warning Message'), 3)
