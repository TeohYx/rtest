...
TestObject inputButton = findTestObject('Object Repository/Motorcar and Motorcycle/Quotation Page/label_ID Type_Army')
...
Map quotationInputScenario = [
	('inputField') : [
			...
			[('inputObject') : findTestObject('Object Repository/Motorcar and Motorcycle/Quotation Page/input_Army ID Number'), ('inputText') : 'RF/123456'],
		]
	]
