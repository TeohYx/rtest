...
Map quotationInputScenario = [
	('inputField') : [
			[('inputObject') : findTestObject('Object Repository/Motorcar and Motorcycle/Quotation Page/input_Passport'), ('inputText') : 'A12341234'],
	...
	('buttonField') : [
			[('buttonClick') : findTestObject('Object Repository/Motorcar and Motorcycle/Quotation Page/button_Select Nationality'),
				('buttonSelection') : findTestObject('Object Repository/Motorcar and Motorcycle/Quotation Page/button_Select Nationality Afghan')],
		]
	]
