...
WebUI.enhancedClick(findTestObject('Object Repository/Motorcar and Motorcycle/Declaration Page/button_PIDM TIPS Brochure'))
...
assert currentUrl.contains(GlobalVariable.link_PIDMBrochuresLink)
