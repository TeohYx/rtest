...
WebUI.enhancedClick(findTestObject('Object Repository/Motorcar and Motorcycle/Declaration Page/button_pidmgov Link'))
...
assert currentUrl.contains(GlobalVariable.link_PIDMgovLink)
