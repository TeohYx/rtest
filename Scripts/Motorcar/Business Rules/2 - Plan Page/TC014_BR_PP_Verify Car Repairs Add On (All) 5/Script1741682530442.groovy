...
TestObject byPassengerButton = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/button_HarmCausedByPassenger')
TestObject toPassengerButton = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/button_HarmCausedToPassengerSingapore')
...
plateLists.each { key, plateList ->
	plateList.each { plate ->
		try {
			 ...
			 */
			if (key == 'negative') {
				isSmartKeyNotPresent = WebUI.verifyElementNotPresent(byPassengerButton, 3, FailureHandling.OPTIONAL)
				isChildCarNotPresent = WebUI.verifyElementNotPresent(toPassengerButton, 3, FailureHandling.OPTIONAL)
				...
				isSmartKeyPresent = WebUI.verifyElementPresent(byPassengerButton, 3, FailureHandling.OPTIONAL)
				isChildCarPresent = WebUI.verifyElementPresent(toPassengerButton, 3, FailureHandling.OPTIONAL)
