...
TestObject addOnObj = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/button_CarAccessoriesCoverage')

TestObject smartKeyTick = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/button_SmartKey')
TestObject childCarTick = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/button_ChildCarSafetySeat')
...
plateLists.each { key, plateList ->
	plateList.each { plate ->
		try {
			 ...
			 */
			if (key == 'negative') {
				isSmartKeyNotPresent = WebUI.verifyElementNotPresent(smartKeyTick, 3, FailureHandling.OPTIONAL)
				isChildCarNotPresent = WebUI.verifyElementNotPresent(childCarTick, 3, FailureHandling.OPTIONAL)
				...
				isSmartKeyPresent = WebUI.verifyElementPresent(smartKeyTick, 3, FailureHandling.OPTIONAL)
				isChildCarPresent = WebUI.verifyElementPresent(childCarTick, 3, FailureHandling.OPTIONAL)
