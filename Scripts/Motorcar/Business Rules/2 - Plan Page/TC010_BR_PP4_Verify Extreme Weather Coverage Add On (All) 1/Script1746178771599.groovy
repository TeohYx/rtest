 ...
 *
 * Test case scenario:
 * 1. Year make: 8 (Positive)
 *
 */

TestObject addOnObj = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/button_Coverage for Harsh Weather Damage')
TestObject addOnValidation = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/1 - Quotation Details/dyvalidation_QuotationDetailsText_text',
	[('text'): GlobalVariable.dyvalidation_addOns['extremeWeather']])
	...
	plateList.each { plate ->
		try {
			...
			if (key == 'negative') {
				...
				isPresent = WebUI.verifyElementPresent(addOnValidation, 3, FailureHandling.OPTIONAL)
				if (!isPresent) {
