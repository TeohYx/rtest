...
String plateNumberBelow5Years = GlobalVariable.rules_carStatus['y4']
String plateNumber5Years = GlobalVariable.rules_carStatus['y5']
String plateNumber15Years = GlobalVariable.rules_carStatus['y15']
String plateNumberAbove15Years = GlobalVariable.rules_carStatus['y16']

int yearMakeBelow5Years = GlobalVariable.rules_carYearMake['year4']
int yearMake5Years = GlobalVariable.rules_carYearMake['year5']
int yearMake15Years = GlobalVariable.rules_carYearMake['year15']
...
Map plateLists = [
		...
		'positive' : [
				['plateNumber': plateNumber5Years, 'yearMake': yearMake5Years],
				['plateNumber': plateNumber15Years, 'yearMake': yearMake15Years]
			]
	]
...
plateLists.each { key, plateList ->
	plateList.each { plate ->
		 ...
		 */
		if (key == 'negative') {
//			isMainPresent = WebUI.verifyElementNotPresent(addOnSection, 3, FailureHandling.OPTIONAL)
