...
TestObject objectLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/input_Home Address 3')
...
WebUI.verifyElementPresent(findTestObject('Motorcar and Motorcycle/Plan Page/3 - Personal Details/input_Postcode'), 0)
