...
TestObject warningMessage = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/wrnmsg_Mobile Number')
...
WebUI.verifyEqual(warningText, GlobalVariable.errorMessage_PersonalDetailMobileNumber)
