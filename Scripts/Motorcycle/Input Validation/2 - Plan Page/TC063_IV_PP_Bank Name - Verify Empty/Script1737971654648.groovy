...
TestObject warningMessage = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/4 - Bank Accounts Details/wrnmsg_Bank Name')
...
WebUI.verifyEqual(warningText, GlobalVariable.errorMessage_BankName)
