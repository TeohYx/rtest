...
TestObject placeholderLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/input_Email')
...
WebUI.verifyEqual(placeholder, GlobalVariable.placeholder_Email)
