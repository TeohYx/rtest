...
TestObject textObject = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/input_Home Address 1')
TestObject warningMessageLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/wrnmsg_Home Address 1')
TestObject submitLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/button_Save Personal Details')
...
CustomKeywords.'inputValidation.validation.verifyCharacterLength'(textObject, warningMessageLocator, submitLocator, "No 45, Jalan Medan Setia 1 Bukit Damansara", "No") // >=5
