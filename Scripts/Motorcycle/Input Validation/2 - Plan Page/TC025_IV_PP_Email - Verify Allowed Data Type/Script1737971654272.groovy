...
TestObject textObject = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/input_Email')
...
(validation, errorMessage) = CustomKeywords.'inputValidation.validation.verifyValidData'('S', textObject, [allowedSymbol: '@_/.,\''])
