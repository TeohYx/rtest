...
TestObject objectLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/input_Email')
...
WebUI.verifyElementPresent(findTestObject('Motorcar and Motorcycle/Plan Page/3 - Personal Details/input_Mobile Number'), 0)
