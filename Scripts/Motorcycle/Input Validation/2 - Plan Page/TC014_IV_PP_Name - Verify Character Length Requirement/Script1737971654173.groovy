...
TestObject textObject = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/input_Name')
TestObject warningMessageLocator = findTestObject('Object Repository/Motorcar and Motorcycle/Plan Page/3 - Personal Details/wrnmsg_Name')
...
CustomKeywords.'inputValidation.validation.verifyCharacterLength'(textObject, warningMessageLocator, submitLocator, "Teoh Yee Xian", "Teoh") // >=5
