...
String placeholder = WebUI.getAttribute(findTestObject('Motorcar and Motorcycle/Quotation Page/input_Army ID Number'), 'placeholder')

WebUI.verifyEqual(placeholder, GlobalVariable.placeholder_IDArmy)
