...
WebUI.enhancedClick(findTestObject('Object Repository/Motorcar and Motorcycle/Declaration Page/button_Privacy Notice'))
...
assert currentUrl.contains(GlobalVariable.link_PrivacyNotice)
