...
WebUI.enhancedClick(findTestObject('Motorcar and Motorcycle/Plan Page/1 - Quotation Details/button_Flexi Personal Accident Show More'))

WebUI.getText(findTestObject('Motorcar and Motorcycle/Plan Page/1 - Quotation Details/txt_Total Flexi PA Contribution'))
