...
String inputTitle = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("OTO360", "detail.gender", "EN")
def inputObj = findTestObject('Object Repository/OTO360/Application Page/dyinput_genderFemale_detail',
	[('detail'): inputTitle])
