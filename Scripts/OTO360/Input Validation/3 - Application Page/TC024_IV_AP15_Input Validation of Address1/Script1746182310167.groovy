...
String placeholderText = "E.G. ADDRESS LINE 1"

def inputObj = findTestObject('Object Repository/OTO360/Application Page/input_address1')
...
String warningInputTitle = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("OTO360", "detail.address1", "EN")
