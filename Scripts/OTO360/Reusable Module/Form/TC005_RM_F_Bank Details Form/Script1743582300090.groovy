...
Map defaultValues = [ // Original parameter names
    	('bankName') : CustomKeywords.'utils.Utility.getOTOInfo'('bankName', infoColumn), 
		('savingAccount') : CustomKeywords.'utils.Utility.getOTOInfo'('savingAccount', infoColumn)
	]
...
WebUI.enhancedClick(findTestObject('Object Repository/OTO360/Application Page/dyinput_detailDropdownSelectionWithoutIdentifier_detail,selection',
	[('detail'): bankName, ('selection'): params['bankName']]))

WebUI.setText(findTestObject('Object Repository/OTO360/Application Page/input_CurrentSavingAccount'), params['savingAccount'])
