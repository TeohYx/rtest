...
String validation = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "FAQvalidation.commence", "EN")
String dropdown = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "FAQdropdown.commence", "EN")
