...
String validation = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "FAQvalidation.emergency", "EN")
String dropdown = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "FAQdropdown.emergency", "EN")
