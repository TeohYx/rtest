...
String validation = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "FAQvalidation.nomination", "EN")
String dropdown = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "FAQdropdown.nomination", "EN")
