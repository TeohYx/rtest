...
String validation = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "FAQvalidation.cancelPolicy", "EN")
String dropdown = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "FAQdropdown.cancelPolicy", "EN")
