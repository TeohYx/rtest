...
String area = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "area.3", "EN")
String planType = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "planType.2", "EN")
