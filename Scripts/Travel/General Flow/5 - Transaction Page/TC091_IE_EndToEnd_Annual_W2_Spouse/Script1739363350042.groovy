...
WebUI.enhancedClick(findTestObject('Travel/TripCare360/English/Quotation Page/dybutton_SelectCountryArea_area', [('area') : 'Worldwide 2']))
...
WebUI.setText(findTestObject('Travel/TripCare360/English/AppPage/text_PassportOrIdentityNumber'), '981224016421')

WebUI.setText(findTestObject('Travel/TripCare360/English/AppPage/text_FullName'), 'testAdult')
