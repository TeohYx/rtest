...
String dropdown = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "benefitDropdown.loss", "EN")
String validation = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "benefitValidation.loss", "EN")
