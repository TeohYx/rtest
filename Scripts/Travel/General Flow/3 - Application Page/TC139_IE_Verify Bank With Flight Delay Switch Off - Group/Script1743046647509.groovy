...
/**
 * Deactivate the flight delay claim switch, and fill up the forms. Both main and secondary traveller info should pass with no error
 * 1. Main traveller info pass 
 * 2. Secondary traveller info pass
 * 
 * @author 80012455
 *
 */
def flightDelayParam = [('isOn') : false]
