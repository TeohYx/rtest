 ...
 * = Number of plans (rows) under PlanType 1 in 'Plan' sheet of 'PlanCombination' 
 ...
 * 		+ Number of adventurous activities (rows) under PlanType 1 in 'Adventurous Activities' sheet of 'PlanCombination'
 * 		+ Number of covid (rows) under PlanType 1 in 'Covid' sheet of 'PlanCombination'
 * 			* (Number of additional week (DateClass 5 in 'DateDuration' sheet of 'PlanCombination' - 1)
 * = 58 + [9 * (2 - 1)] + 9 + 15 + [3 * (2 - 1)]
 * = 67 + 9 + 18
 * = 94
