...
Boolean isItemNotPresent = WebUI.verifyElementNotPresent(itemObject, 3, FailureHandling.OPTIONAL)

WebUI.takeFullPageScreenshot()
WebUI.closeBrowser()

assert isItemPresent && isItemNotPresent : KeywordUtil.markFailed("${item} have some issue")
