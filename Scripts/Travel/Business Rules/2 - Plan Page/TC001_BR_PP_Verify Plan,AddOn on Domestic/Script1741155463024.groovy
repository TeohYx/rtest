...
/*
 * When domestic is select:
 * - Only 1 plan can be chosen
...
if (!(WebUI.verifyElementNotPresent(findTestObject('Travel/TripCare360/English/Plan Page/button_GoldPlan'), 3, FailureHandling.OPTIONAL))) {
    errorMessage.add('Gold plan does not exists')
}

if (!(WebUI.verifyElementNotPresent(findTestObject('Travel/TripCare360/English/Plan Page/button_PlatinumPlan'), 3, FailureHandling.OPTIONAL))) {
