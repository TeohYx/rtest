...
String ageRange = GlobalVariable.rules_FamilyOwner
...
resultCase.each { cases, ics ->
	ics.each { ic -> 
		WebUI.enhancedClick(findTestObject('Object Repository/Travel/TripCare360/English/AppPage/button_EditPolicyOwner'), FailureHandling.OPTIONAL)
