...
boolean isNotPresent = WebUI.verifyElementNotPresent(domesticAreaObj, 10, FailureHandling.OPTIONAL)

assert isNotPresent : "Domestic Area still present under Annual Trip."