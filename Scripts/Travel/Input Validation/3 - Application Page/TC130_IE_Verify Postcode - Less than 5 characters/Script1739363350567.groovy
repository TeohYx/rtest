...
String postcode = CustomKeywords.'utils.Utility.getDynamicRepoInfo'("Travel", "travellerInfo.postcode", "EN")
...
WebUI.setText(findTestObject('Travel/TripCare360/English/AppPage/input_Postcode'), '1234')
