...
WebUI.setText(findTestObject('Travel/TripCare360/English/AppPage/text_AreaName'), invalid_character)

WebUI.enhancedClick(findTestObject('Travel/TripCare360/English/AppPage/button_PersonalDetailsSaveChanges'))

String area_name_text = WebUI.getAttribute(findTestObject('Travel/TripCare360/English/AppPage/Warning Message Text/wrnmsg_Area,Sub-Area Name'), "value") ?: ""
