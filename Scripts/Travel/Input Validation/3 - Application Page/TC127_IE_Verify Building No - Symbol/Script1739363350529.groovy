...
String building_name_text = WebUI.getAttribute(findTestObject('Travel/TripCare360/English/AppPage/Warning Message Text/dywrnmsg_TravellerInfo_travellerInfo', [
	('travellerInfo') : buildingName]), "value") ?: ""

WebUI.closeBrowser()

assert building_name_text.isEmpty() : "The Building Name field is not empty and contains ${building_name_text}"
