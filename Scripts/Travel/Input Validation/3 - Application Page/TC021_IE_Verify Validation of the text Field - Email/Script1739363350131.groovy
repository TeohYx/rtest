...
WebUI.setText(findTestObject('Travel/TripCare360/English/AppPage/text_Email'), 'testingmail')

WebUI.enhancedClick(findTestObject('Travel/TripCare360/English/AppPage/button_PersonalDetailsSaveChanges'))

WebUI.verifyElementPresent(findTestObject('Travel/TripCare360/English/AppPage/lbl_Please enter valid email'), 0)
