...
WebUI.setText(findTestObject('Travel/TripCare360/English/AppPage/text_Email'), 'testing@gmail.com')

WebUI.setText(findTestObject('Travel/TripCare360/English/AppPage/text_MobileNumber'), '0123456789')

WebUI.setText(findTestObject('Travel/TripCare360/English/AppPage/text_BuildingName'), 'bn')

WebUI.enhancedClick(findTestObject('Travel/TripCare360/English/AppPage/button_PersonalDetailsSaveChanges'))

WebUI.verifyElementPresent(findTestObject('Travel/TripCare360/English/AppPage/lbl_Must be at least 5 characters'), 0)
